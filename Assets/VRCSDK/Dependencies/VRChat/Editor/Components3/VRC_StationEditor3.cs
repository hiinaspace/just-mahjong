...
namespace VRC.SDK3.Editor
{
    ...
    public class VRCStationEditor3 : UnityEditor.Editor
    {
        ...
        //private SerializedProperty playerMobilityProperty;
        ...
        public override void OnInspectorGUI()
        {
            ...
            //playerMobilityProperty = serializedObject.FindProperty("playerMobility");
        ...
        //    proximityProperty = serializedObject.FindProperty("proximity");
            ...
            //EditorGUILayout.PropertyField(playerMobilityProperty, new GUIContent("Player Mobility"));
